...
$(document).ready(function () {
			...
			function fetch_data(){
				...
				$.ajax({
	                	...
	                	url:"template/pages/fetch_cart.php",

		                method:"POST",
		                success: function(data){

		                    // alert(data);
		                    $('#live_order').html(data);
			...
			fetch_data();
 			...
 			$(".add_to_cart").click(function() {
  				 ...
  				 // alert($(this).find('.menu_id').val());
  				var user_id = $(this).find('.user_id').val();
  				var m_price = $(this).find('.m_price').val();
  				...
  				// alert(menu_id);
  					...
  					$.ajax({
	                	...
	                	url:"template/pages/insert_cart.php",
